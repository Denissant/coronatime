<x-dashboard.wrapper :title="__('Worldwide Statistics')">
    <div class="flex flex-wrap justify-between sm:flex-nowrap sm:space-x-6">
        <x-dashboard.stat-figure index="1" :caption="__('New cases')" number="{{ $worldwideStats['confirmed'] }}"
                                 background_color_class="bg-[#EEEEFE]" text_color_class="text-brand-blue" graph_color="blue"/>
        <x-dashboard.stat-figure index="2" :caption="__('Recovered')" number="{{ $worldwideStats['recovered'] }}"
                                 background_color_class="bg-[#EAF8F1]" text_color_class="text-brand-lightgreen" graph_color="green"/>
        <x-dashboard.stat-figure index="3" :caption="__('Deaths')" number="{{ $worldwideStats['deaths'] }}"
