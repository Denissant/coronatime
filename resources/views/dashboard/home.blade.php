<x-dashboard.wrapper>
    <div class="flex flex-wrap justify-between sm:flex-nowrap sm:space-x-6">
        ...
        <x-dashboard.stat-figure index="2" caption="Recovered" number="{{ $worldwideStats['recovered'] }}"
                                 background_color_class="bg-[#EAF8F1]" text_color_class="text-brand-lightgreen" graph_color="green"/>
        <x-dashboard.stat-figure index="3" caption="Deaths" number="{{ $worldwideStats['deaths'] }}"
