...
<table class="block overflow-auto absolute left-0 max-h-[60vh] mt-6 sm:mt-10 sm:static sm:shadow-lg sm:rounded-lg min-w-full border-collapse">
    <thead class="sticky top-0 bg-[#F6F6F7] sm:rounded-lg flex">
        <tr class="h-14 sm:rounded-lg flex items-center w-full">
            <x-dashboard.table-column class="sm:rounded-tl-lg">Location</x-dashboard.table-column>
            <x-dashboard.table-column>New Cases</x-dashboard.table-column>
            <x-dashboard.table-column>Deaths</x-dashboard.table-column>
            <x-dashboard.table-column class="sm:rounded-tr-lg">Recovered</x-dashboard.table-column>
        </tr>
    </thead>
