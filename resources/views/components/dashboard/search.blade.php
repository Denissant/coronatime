<form class="relative" method="GET">
    ...
    <label for="search" class="sr-only">{{ __('dashboard.search_countries') }}</label>
    <input id="search" name="search" placeholder="{{ __('dashboard.search_countries') }}" type="text" value="{{ request('search') }}"
